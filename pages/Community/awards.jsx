...
export default function Awards() {
  return (
    ...
    <>
     <Head>
        <title>Unreveal Awards | Creators Everywhere</title>
        <meta
          name="description"
      ...
      <div className="w-full">
       <img className='w-full' src="https://images.pexels.com/photos/4271927/pexels-photo-4271927.jpeg" alt="Coming Soon..." />
      </div>
    </>
  )
}
